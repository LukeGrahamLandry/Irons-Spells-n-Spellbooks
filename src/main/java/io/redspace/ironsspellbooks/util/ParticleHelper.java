...
public class ParticleHelper {
    ...
    public static final IParticleData ICY_FOG = new FogParticleOptions(new Vector3f(208 / 255f, 249 / 255f, 255 / 255f), 0.6f);
    public static final IParticleData SUNBEAM = new FogParticleOptions(new Vector3f(0.95f, 0.97f, 0.36f), 1f);
    public static final IParticleData FIREFLY = ParticleRegistry.FIREFLY_PARTICLE.get();
