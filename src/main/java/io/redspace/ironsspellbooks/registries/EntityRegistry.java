...
//                    .build(new ResourceLocation(IronsSpellbooks.MODID, "summoned_frog").toString()));
    ...
    public static final RegistryObject<EntityType<EarthquakeAoe>> EARTHQUAKE_AOE =
            ENTITIES.register("earthquake_aoe", () -> EntityType.Builder.<EarthquakeAoe>of(EarthquakeAoe::new, EntityClassification.MISC)
                    .sized(4f, .8f)
                    .clientTrackingRange(64)
    ...
    public static final RegistryObject<EntityType<VisualFallingBlockEntity>> FALLING_BLOCK =
            ENTITIES.register("visual_falling_block", () -> EntityType.Builder.<VisualFallingBlockEntity>of(VisualFallingBlockEntity::new, EntityClassification.MISC)
                    .sized(0.98F, 0.98F)
                    .clientTrackingRange(10)
                    .updateInterval(20)
    ...
    public static final RegistryObject<EntityType<RayOfFrostVisualEntity>> RAY_OF_FROST_VISUAL_ENTITY =
            ENTITIES.register("ray_of_frost", () -> EntityType.Builder.<RayOfFrostVisualEntity>of(RayOfFrostVisualEntity::new, EntityClassification.MISC)
                    .sized(1f, 1f)
                    .clientTrackingRange(64)
    ...
    public static final RegistryObject<EntityType<FireflySwarmProjectile>> FIREFLY_SWARM =
            ENTITIES.register("firefly_swarm", () -> EntityType.Builder.<FireflySwarmProjectile>of(FireflySwarmProjectile::new, EntityClassification.MISC)
                    .sized(.9f, .9f)
                    .clientTrackingRange(64)
