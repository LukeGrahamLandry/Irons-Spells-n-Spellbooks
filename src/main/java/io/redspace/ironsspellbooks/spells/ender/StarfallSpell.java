...
public class StarfallSpell extends AbstractSpell {
    ...
    public void shootComet(World world, LivingEntity entity, Vector3d spawn) {
        ...
        world.playSound(null, spawn.x, spawn.y, spawn.z, SoundEvents.FIREWORK_ROCKET_LAUNCH, SoundCategory.PLAYERS, 3.0f, 0.7f + world.random.nextFloat() * .3f);
