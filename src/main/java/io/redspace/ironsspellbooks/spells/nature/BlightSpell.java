...
public class BlightSpell extends AbstractSpell {
    ...
    public List<IFormattableTextComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(
                ITextComponent.translatable("ui.irons_spellbooks.reduced_healing", Utils.stringTruncation((1 + getAmplifier(spellLevel, caster)) * BlightEffect.HEALING_PER_LEVEL * -100, 1)),
                ITextComponent.translatable("ui.irons_spellbooks.reduced_damage", Utils.stringTruncation((1 + getAmplifier(spellLevel, caster)) * BlightEffect.DAMAGE_PER_LEVEL * -100, 1)),
